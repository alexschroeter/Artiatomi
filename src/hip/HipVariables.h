  ...
  */
  ...
  public:
    ...
    */
    ...
    void CopyHostToDeviceAsync(hipStream_t stream, void* aSource, size_t aSizeInBytes = 0);
  
    void CopyDeviceToHostAsync(hipStream_t stream, void* aDest, size_t aSizeInBytes = 0);

    void CopyDeviceToDeviceAsync(hipStream_t stream, Hip::HipDeviceVariable& var);
  };
