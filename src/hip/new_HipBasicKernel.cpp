...
HipSub::HipSub(int aVolSize, hipStream_t aStream, Hip::HipContext* context)
    ...
    : volSize(aVolSize), stream(aStream), ctx(context), blockSize(1024, 1, 1), 
    gridSize(aVolSize*aVolSize*aVolSize/1024, 1, 1)
{
...
HipMakeCplxWithSub::HipMakeCplxWithSub(int aVolSize, hipStream_t aStream, Hip::HipContext* context)
    ...
    // : volSize(aVolSize), stream(aStream), ctx(context), blockSize(16, 8, 8), 
    //   gridSize(aVolSize / 16, aVolSize / 8, aVolSize / 8)
      ...
      gridSize(aVolSize*aVolSize*aVolSize/1024, 1, 1)
{
    ...
    makeCplxZero = new HipKernel("makeCplxZero", kernelModule);
}

void HipMakeCplxWithSub::runZeroKernel(HipDeviceVariable& d_idata, HipDeviceVariable& d_odata)
{
    hipDeviceptr_t in_dptr = d_idata.GetDevicePtr();
    hipDeviceptr_t out_dptr = d_odata.GetDevicePtr();
    ...
    hipSafeCall(hipModuleLaunchKernel(makeCplxZero->GetHipFunction(), gridSize.x, gridSize.y,
        gridSize.z, blockSize.x, blockSize.y, blockSize.z, 0, stream, arglist,NULL));
...
void HipMakeCplxWithSub::MakeCplxZero(HipDeviceVariable& d_idata, HipDeviceVariable& d_odata)
{
    runZeroKernel(d_idata, d_odata);
}
      ...
      gridSize(aVolSize*aVolSize*aVolSize/1024, 1, 1)
{
    ...
    mul_RR = new HipKernel("mul_RR", kernelModule);
}
...
void HipMul::runMulVol_RRKernel(HipDeviceVariable& d_idata, HipDeviceVariable& d_odata)
{
    hipDeviceptr_t in_dptr = d_idata.GetDevicePtr();
    hipDeviceptr_t out_dptr = d_odata.GetDevicePtr();
    ...
    hipSafeCall(hipModuleLaunchKernel(mulVol_RR->GetHipFunction(), gridSize.x, gridSize.y,
        gridSize.z, blockSize.x, blockSize.y, blockSize.z, 0, stream, arglist,NULL));
...
void HipMul::MulVol_RR(HipDeviceVariable& d_idata, HipDeviceVariable& d_odata)
{
    runMulVol_RRKernel(d_idata, d_odata);
}
...
void HipMul::runMul_RRKernel(float val, HipDeviceVariable& d_odata)
{
    hipDeviceptr_t out_dptr = d_odata.GetDevicePtr();
    ...
    hipSafeCall(hipModuleLaunchKernel(mul_RR->GetHipFunction(), gridSize.x, gridSize.y,
        gridSize.z, blockSize.x, blockSize.y, blockSize.z, 0, stream, arglist,NULL));
...
void HipMul::Mul_RR(float val, HipDeviceVariable& d_odata)
{
    runMul_RRKernel(val, d_odata);
}
...
HipFFT::HipFFT(int aVolSize, hipStream_t aStream, Hip::HipContext* context)
    ...
    : volSize(aVolSize), stream(aStream), ctx(context), blockSize(32, 32, 1), 
      gridSize(aVolSize / 32, aVolSize / 32, aVolSize / 1)
{
	hipModule_t kernelModule = ctx->LoadModule("basicKernels.ptx");
...
void HipFFT::runEnergyNormKernel(HipDeviceVariable& d_particle, HipDeviceVariable& d_partSqr, HipDeviceVariable& d_cccMap, HipDeviceVariable& energyRef, HipDeviceVariable& nVox)
{
...
void HipFFT::EnergyNorm(HipDeviceVariable& d_particle, HipDeviceVariable& d_partSqr, HipDeviceVariable& d_cccMap, HipDeviceVariable& energyRef, HipDeviceVariable& nVox)
{
...
void HipSub_RC::runSubCplxKernel(HipDeviceVariable& d_idata, HipDeviceVariable& d_odata, HipDeviceVariable& val, HipDeviceVariable& divVal)
{
    hipDeviceptr_t in_dptr = d_idata.GetDevicePtr();
    hipDeviceptr_t out_dptr = d_odata.GetDevicePtr();
    hipDeviceptr_t val_dptr = val.GetDevicePtr();
...
void HipSub_RC::SubCplx(HipDeviceVariable& d_idata, HipDeviceVariable& d_odata, HipDeviceVariable& val, HipDeviceVariable& divVal)
{
    runSubCplxKernel(d_idata, d_odata, val, divVal);
}
*/
...
*/
/*
void HipFFT_RC::runEnergyNorm_RCKernel(HipDeviceVariable& d_particle, HipDeviceVariable& d_partSqr, HipDeviceVariable& d_cccMap, HipDeviceVariable& energyRef, HipDeviceVariable& nVox)
{
    hipDeviceptr_t particle_dptr = d_particle.GetDevicePtr();
    hipDeviceptr_t partSqr_dptr = d_partSqr.GetDevicePtr();
    hipDeviceptr_t cccMap_dptr = d_cccMap.GetDevicePtr();
...
void HipFFT_RC::EnergyNorm_RC(HipDeviceVariable& d_particle, HipDeviceVariable& d_partSqr, HipDeviceVariable& d_cccMap, HipDeviceVariable& energyRef, HipDeviceVariable& nVox)
{
    runEnergyNorm_RCKernel(d_particle, d_partSqr, d_cccMap, energyRef, nVox);
}
*/