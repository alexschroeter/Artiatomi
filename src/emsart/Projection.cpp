...
void Projection::ComputeHitPoints(Volume<unsigned short>& vol, uint index, int2& pA, int2& pB, int2& pC, int2& pD)
{
  ...
  //float3 borderMin = make_float3(FLT_MAX,FLT_MAX,FLT_MAX);
  //float3 borderMax = make_float3(-FLT_MAX,-FLT_MAX,-FLT_MAX);
