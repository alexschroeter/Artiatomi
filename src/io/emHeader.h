...
{
    //! Machine Coding
    EmMachine_Enum MachineCoding;
    //! Not used
    char NotUsed1;
    //! Not used
    char NotUsed2;
    //! Data type coding
    EmDataType_Enum DataType;
